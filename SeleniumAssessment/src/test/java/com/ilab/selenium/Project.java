...
driver.findElement(By.id(Locators.usernameTextbox)).sendKeys(InputValues.UserNamelogin);
driver.findElement(By.id(Locators.passwordTextbox)).clear();
driver.findElement(By.id(Locators.passwordTextbox)).sendKeys(InputValues.Password);
...
driver.findElement(By.id("systemUser_employeeName_empName")).sendKeys(InputValues.Employee_Name);



driver.findElement(By.id("systemUser_userName")).clear();
driver.findElement(By.id("systemUser_userName")).sendKeys(InputValues.UserName);



driver.findElement(By.id("systemUser_password")).clear();
driver.findElement(By.id("systemUser_password")).sendKeys("Selenium500");



driver.findElement(By.id("systemUser_confirmPassword")).clear();
driver.findElement(By.id("systemUser_confirmPassword")).sendKeys("Selenium500");
...
driver.findElement(By.id("systemUser_employeeName_empName")).clear();
driver.findElement(By.id("systemUser_employeeName_empName")).sendKeys(Employee_Name);
