...
public class Admin extends SetUp {
	...
	public void validateAdminUrl() { 
		...
		test = extent.createTest("Url should contain admin/viewSystemUsers", "Validate that url contain admin/viewSystemUsers"); 

		//admin url
		String admin_url = Locators.adminUrl; 
	...
	public void validateAdd () { 
		...
		WebElement save_btn = driver.findElement(By.name(Locators.saveBtn)); 
	...
	public void validateDelete() { 
		...
		//calling web element by name
		WebElement delete_btn = driver.findElement(By.name(Locators.deleteBtn)); 
	...
	public void validateReset() { 
		...
		//calling web element by name
		WebElement reset_btn = driver.findElement(By.name(Locators.resetBtn)); 
